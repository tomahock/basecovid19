...
<footer class="page-footer font-small mt-3">
    ...
    <div class="container">
        ...
        <div class="row d-flex text-center justify-content-center mb-md-0 mb-4">
            ...
            <div class="col-md-10 col-12 mt-5">
                ...
                <p style="line-height: 1.7rem">Se acha que um contrato não devia aparecer nesta página, entre nos detalhes do contrato e clic no botão de reportar <i class="fas fa-bullhorn"></i></p>
            </div>
            <!-- Grid column -->
    ...
    <div class="footer-copyright text-center py-3">
        <a href="https://twitter.com/basecovid19" target="_blank"><i class="fab fa-twitter fa-lg white-text mr-4"></i></a>
        <a href="https://github.com/tomahock/basecovid19" target="_blank"><i class="fab fa-github fa-lg white-text mr-4"></i></a>
    </div>
